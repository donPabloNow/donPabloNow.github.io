...
(function($) {
  ...
  TagsInput.prototype = {
    ...
    build: function(options) {
      ...
      // When itemValue is set,Input should always be false
      if (self.objectItems)
      ...
      if (self.options.typeaheadjs) {
        ...
        var valueKey = typeaheadjs[1].valueKey; // I should test typeaheadjs.size >= 1
  ...
  function htmlEncode(value) {
    if (value) {
      return htmlEncodeContainer.text(value)();
    } else {
      return '';
    }
  }
