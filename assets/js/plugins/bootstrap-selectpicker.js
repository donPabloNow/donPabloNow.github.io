...
(function(root, factory) {
  ...
  (function($) {
    ...
    var Selectpicker = function(element, options) {
      ...
      // If I have no title yet, try to pull it from the html title attribute (jQuery doesnt' pick it up as it's not a
      // data-attribute)
    ...
    Selectpicker.prototype = {
      ...
      createDropdown: function() {
        // Options
        // If I am a multiple or showTick option is set, then add the show-tick class
      ...
      setMenuSize: function(isAuto) {
        ...
        if (this.options.dropupAuto) {
          ...
          // below the button without setting dropup, but I can't know
      ...
      clickListener: function() {
        ...
        this.$menuInner.on('click', 'li a', function(e, retainActive) {
          ...
          if (!that.isDisabled() && !$this.parent().hasClass(classNames.DISABLED)) {
            ...
            } else { // Toggle the one I have chosen if I am a multi select.
